//
//  BookMarkAccommodationViewController.swift
//  TravelTale
//
...
// MARK: - extensions
extension BookMarkAccommodationViewController: IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "숙박")
    }
}

extension BookMarkAccommodationViewController: UITableViewDataSource {
