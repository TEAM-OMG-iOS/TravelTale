...
final class SearchResultTabAccommodationViewController: BaseViewController {
    ...
    private lazy var bookmarks = realmManager.fetchBookmarks(contentTypeId: .accommodation)
...
// MARK: - extensions
extension SearchResultTabAccommodationViewController: IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "숙박")
    }
}

extension SearchResultTabAccommodationViewController: UITableViewDelegate {
...
extension SearchResultTabAccommodationViewController: UITableViewDataSource {
