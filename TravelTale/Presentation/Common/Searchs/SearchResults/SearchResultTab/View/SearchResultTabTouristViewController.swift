...
final class SearchResultTabTouristViewController: BaseViewController {
    ...
    private lazy var bookmarks = realmManager.fetchBookmarks(contentTypeId: .tourist)
...
// MARK: - extensions
extension SearchResultTabTouristViewController: IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "관광지")
    }
}

extension SearchResultTabTouristViewController: UITableViewDelegate {
...
extension SearchResultTabTouristViewController: UITableViewDataSource {
